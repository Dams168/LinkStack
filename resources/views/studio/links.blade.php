                                            ...
                                            <div class='col h-100'>
                                                ...
                                                <div class='row h-100'>
                                                    ...
                                                    <div class='col-12 py-1 px-3 m-0 mt-2'>
                                                        ...
                                                        <form action="{{ route('toggleEnableLink', $link->id) }}" method="POST" class="inline-block ml-3">
                                                            @csrf
                                                            <input type="range"
                                                                min="0"
                                                                max="1"
                                                                step="1"
                                                                value="{{ $link->is_enable ? 1 : 0 }}"
                                                                onchange="this.form.submit()"
                                                                class="w-12 h-2 rounded-lg appearance-none cursor-pointer
                                                                        {{ $link->is_enable ? 'bg-green-500' : 'bg-gray-300' }}">
                                                        </form>
                                                        @if(!empty($link->link))
