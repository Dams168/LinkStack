                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        ...
                        <div class="form-group col-lg-8">
                           ...
                           <textarea class="form-control ckeditor" name="privacy"
                              rows="3">{{  $page->privacy }}</textarea>
                        </div>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        ...
                        <div class="form-group col-lg-8">
                           ...
                           <textarea class="form-control ckeditor" name="contact"
                              rows="3">{{ $page->contact }}</textarea>
                        </div>
